...
namespace MCKJ
{
    public partial class frmAdvance : Form
    {
        ...
        private bool validateFields()
        {
            ...
            if (txtFCardNo.Text == "" || txthbkReceipt.Text == "")
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (validateFields())
                {
                    ...
                    int hbkRec = Convert.ToInt32(txthbkReceipt.Text);
                    ...
                    if (mode == 0)
                    {
                        ...
                        for (int x = 0; x < countt; x++)
                        {
                            ...
                            decimal Persons = Convert.ToDecimal(dgvHallBooking.Rows[x].Cells[1].Value.ToString());
                            decimal PerPerson = Convert.ToDecimal(dgvHallBooking.Rows[x].Cells[2].Value.ToString());
                        ...
                        tblTransactionsTableAdapter.InsertTransaction(Account, "ADV",receipt, Date, TotalAmount, 0, "Advance for Hall Booking", "", "");
                    ...
                    else if (mode == 1)
                    {
                        ...
                        for (int x = 0; x < countt; x++)
                        {
                            ...
                            int Event = Convert.ToInt32(dgvHallBooking.Rows[x].Cells[0].Value.ToString());
                            decimal Persons = Convert.ToDecimal(dgvHallBooking.Rows[x].Cells[1].Value);
                            decimal PerPerson = Convert.ToDecimal(dgvHallBooking.Rows[x].Cells[2].Value.ToString());
                            decimal Amount = Convert.ToDecimal(dgvHallBooking.Rows[x].Cells[3].Value.ToString());
                            TotalAmount += Amount;
                            bool result = false;
